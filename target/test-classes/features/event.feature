...
@event
  ...
  Scenario: Successfully create a new event in In-campus type
    ...
    And I enter event title as "July Campus Drive 4"
    And I select event start date as "2025-07-26 12:30 PM"
    And I select event end date as "2025-07-27 12:00 PM"
    And I select registration start date as "2025-07-24 12:00 PM"
    And I select registration end date as "2025-07-25 12:00 PM"
    ...
    Then I search and verify event "July Campus Drive 4" is visible
  ...
  And I select "100" items per page in the event table
  When I click on the "New Event" button on Event page
  And I enter event title as "July F2F Drive 1"
  ...
  And I select institution Name as "XYZ INSTITUTE OF TECHNOLOGY"
  And I enter institution address as "Face to face venue address"
  And I submit the event
  Then I should see event created successfully message
  Then I search and verify event "July F2F Drive 1" is visible
